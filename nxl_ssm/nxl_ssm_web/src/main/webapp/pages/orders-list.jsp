							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" id="modifyOrders"  title="修改">
										...
										<button type="button" class="btn btn-default" id="deleteOrders"  title="删除">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											<td><input name="ids" type="checkbox" id="ids" value="${orders.id}"></td>
											<td>${orders.id }</td>
           ...
           $("#deleteOrders").click(function () {
                   ...
                   if (checkedbox.length==0){
                       ...
                       if (confirm("您确定要删除么?")){
                           ...
                           window.location.href="${pageContext.request.contextPath}/orders/delete?pids="+pids;
                        }
                    }
