				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="<fmt:formatDate value="${orders.product.departureTime}"
                                                        pattern="yyyy-MM-dd"></fmt:formatDate>"
								readonly="readonly">
						</div>
					</div>
						...
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="15"
									value=" <c:if test="${traveller.credentialsType==0}">身份证</c:if>
											<c:if test="${traveller.credentialsType==1}">军官证</c:if>
									" readonly="readonly"></td>
