        ...
        <section class="content">
            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${pageInfo.list}" var="product">
                                ...
                                <tr>
                                    <td><input name="ids" type="checkbox" id="checkbox"></td>
                                    <td>${product.id }</td>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li><a href=href="${pageContext.request.contextPath}/product/findAll?page=1&size=${pageInfo.pageSize}" aria-label="Previous" aria-label="Previous">首页</a></li>
