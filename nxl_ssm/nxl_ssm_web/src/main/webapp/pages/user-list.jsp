                            ...
                            <c:forEach items="${pageInfo.list}" var="user">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${user.status==0}">未开启</c:if>
                                        <c:if test="${user.status==1}">开启</c:if>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <a onclick='delefun("${user.id}")'
                                           class="btn bg-olive btn-xs">删除角色</a>
                                        <a href="${pageContext.request.contextPath}/user/findUesrByIdToModify?id=${user.id}"
                                           class="btn bg-olive btn-xs">修改信息</a>
...
<script>
    ...
    function delefun(id) {
        if (confirm("您确定要删除么????")) {
            ...
            alert(id);
            window.location.href="${pageContext.request.contextPath}/user/findUserRoleById?id="+id;
