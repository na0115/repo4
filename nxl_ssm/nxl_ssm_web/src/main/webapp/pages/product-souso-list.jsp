                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" id="modifyProduct"  title="修改">
                                        <i class="fa-eraser"></i> 修改
                                    </button>
                                    <button type="button" class="btn btn-default" id="shaxin" title="刷新">
                                        <i class="fa fa-refresh"  ></i> 刷新
                                    </button>

                                    <button type="button" class="btn btn-default" id="deleteProduct" title="删除">
                                        <i class="fa fa-trash-o"></i> 删除
                                    </button>

                                    <button type="button" class="btn btn-default" id="添加" title="添加"
                                            onclick="location.href='${pageContext.request.contextPath}/product/addProductSearchIndex'">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback">
                                <form action="findProductSearch" method="post">
                                <input type="text" class="form-control input-sm"
                                       placeholder="搜索" name="souso" value=""> <span
                        ...
                        <table id="dataList"
                            ...
                            <c:forEach items="${productList}" var="product">
                                ...
                                <tr>
                                    <td><input name="ids" type="checkbox" id="ids"  value="${product.id}" ></td>
                                    <td>${product.id }</td>
                                 ...
                                 <%--   <td><fmt:formatDate value="${product.departureTime}"
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/pages/orders-add.jsp?id=${product.id}'">订单</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#modifyProduct").click(function () {
            var checkedbox= $("input[id^=ids]:checked");
            if (checkedbox.length==1){
                /*if (confirm("您确定要修改么?")){*/
                    ...
                    window.location.href="${pageContext.request.contextPath}/product/findProduct?pid="+pid;
             /*   }*/
       ...
       $("#deleteProduct").click(function () {
           ...
           if (checkedbox.length==0){
              ...
              if (confirm("您确定要删除么?")){
                   ...
                   window.location.href="${pageContext.request.contextPath}/product/delete?pids="+pids;
               }
           }
