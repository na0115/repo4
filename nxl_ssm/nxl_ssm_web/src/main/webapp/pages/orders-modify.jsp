	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/product/findAll">订单管理</a></li>
			...
			<form action="${pageContext.request.contextPath}/product/update"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">订单名称</div>
						<div class="col-md-4 data">
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<%-- <td><fmt:formatDate placeholder="${product.departureTime}"
                                                        pattern="yyyy-MM-dd"></fmt:formatDate></td>--%>

								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="departureTime" value="<fmt:formatDate value="${product.departureTime}" pattern="yyyy-MM-dd HH:mm"/>">
							</div>
						</div>
